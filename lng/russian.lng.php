...
$lng['error']['directorymustexist'] = 'Каталог %s должен существовать. Создайте его с помощью FTP-клиента.';
$lng['error']['filemustexist'] = 'Файл %s должен существовать.';
$lng['error']['allresourcesused'] = 'Вы уже использовали все свои ресурсы.';
$lng['error']['domains_cantdeletemaindomain'] = 'Вы не можете удалить домен, который используеться в качестве домена электронной почты.';
$lng['error']['domains_canteditdomain'] = 'Вы не можете редактировать этот домен. Эта функция отключена Администратором.';
$lng['error']['domains_cantdeletedomainwithemail'] = 'Вы не можете удалить домен, который используется в качестве домена электронной почты. Сначала удалите все адреса электронной почты.';
$lng['error']['firstdeleteallsubdomains'] = 'Сначала вы должны удалить все поддомены прежде, чем сможете создать подстановочный домен.';
$lng['error']['youhavealreadyacatchallforthisdomain'] = 'Вы уже определили catch-all для этого домена.';
$lng['error']['ftp_cantdeletemainaccount'] = 'Вы не можете удалить свою основную учетную запись FTP.';
$lng['error']['login'] = 'Неверное имя пользователя или пароль. Повторите попытку!';
$lng['error']['login_blocked'] = 'Эта учетная запись была временно заблокирована из-за слишком большого количества ошибок входа. <br />Повторите попытку через %s секунд.';
$lng['error']['notallreqfieldsorerrors'] = 'Вы не заполнили все поля или заполнили некоторые поля неправильно.';
$lng['error']['oldpasswordnotcorrect'] = 'Неверный старый пароль.';
$lng['error']['youcantallocatemorethanyouhave'] = 'Вы не можете выделить больше ресурсов, чем вы владеете.';
$lng['error']['mustbeurl'] = 'Вы не набрали действительный или полный URL-адрес (например http://somedomain.com/error404.htm)';
$lng['error']['invalidpath'] = 'Вы не выбрали действительный URL-адрес (возможно, проблемы с листингом каталога?)';
$lng['error']['stringisempty'] = 'Отсутствие ввода в поле';
$lng['error']['stringiswrong'] = 'Неправильный ввод в поле';
$lng['error']['newpasswordconfirmerror'] = 'Новый пароль и подтверждение не совпадают';
$lng['error']['mydomain'] = '\'Domain\'';
$lng['error']['mydocumentroot'] = '\'Documentroot\'';
$lng['error']['loginnameexists'] = 'Имя входа %s уже существует';
$lng['error']['emailiswrong'] = 'Email-адрес %s содержит недопустимые символы или является неполным';
$lng['error']['loginnameiswrong'] = 'Имя входа "%s" содержит недопустимые символы.';
$lng['error']['loginnameiswrong2'] = 'Имя входа содержит слишком много знаков. Разрешены только следующие знаки: %s .';
$lng['error']['userpathcombinationdupe'] = 'Комбинация имени пользователя и пути уже существует';
$lng['error']['patherror'] = 'Общая ошибка! Путь не может быть пустым';
$lng['error']['errordocpathdupe'] = 'Параметр для пути %s уже существует';
$lng['error']['adduserfirst'] = 'Сначала создайте клиента';
$lng['error']['domainalreadyexists'] = 'Домен %s уже назначен клиенту';
$lng['error']['nolanguageselect'] = 'Язык не выбран.';
$lng['error']['nosubjectcreate'] = 'Вы должны определить тему для этого почтового шаблона.';
$lng['error']['nomailbodycreate'] = 'Вы должны определить почтовый текст для этого почтового шаблона.';
$lng['error']['templatenotfound'] = 'Шаблон не найден.';
$lng['error']['alltemplatesdefined'] = 'Вы не можете определить больше шаблонов, все языки уже поддерживаются.';
$lng['error']['wwwnotallowed'] = 'www недопустим для субдоменов.';
$lng['error']['subdomainiswrong'] = 'Субдомен %s содержит недопустимые символы.';
$lng['error']['domaincantbeempty'] = 'Имя домена не может быть пустым.';
$lng['error']['domainexistalready'] = 'Домен %s уже существует.';
$lng['error']['domainisaliasorothercustomer'] = 'Выбранный alias домен либо сам является alias доменом, имеет другую комбинацию ip / port, либо принадлежит другому клиенту.';
$lng['error']['emailexistalready'] = 'Адрес электронной почты %s уже существует.';
$lng['error']['maindomainnonexist'] = 'Основной домен %s не существует.';
$lng['error']['destinationnonexist'] = 'Пожалуйста создайте своего переадресатора в поле \'Назначение\'.';
$lng['error']['destinationalreadyexistasmail'] = 'Переадресатор для %s уже существует как активный почтовый адрес.';
$lng['error']['destinationalreadyexist'] = 'Вы уже определили переадресатора для %s .';
$lng['error']['destinationiswrong'] = 'Переадресатор %s содержит недопустимый(е) знак(и) или не полный.';
$lng['error']['ticketnotaccessible'] = 'Вы не можете получить доступ к этому тикету.';
...
$lng['admin']['systemdetails'] = 'Сведения о системе';
$lng['admin']['froxlordetails'] = 'Детали Froxlor';
$lng['admin']['installedversion'] = 'Установленная версия';
$lng['admin']['latestversion'] = 'Последняя версия';
$lng['admin']['lookfornewversion']['clickhere'] = 'Поиск через webservice';
...
$lng['admin']['customer_edit'] = 'Редактировать клиента';
$lng['admin']['domains'] = 'Домены';
$lng['admin']['domain_add'] = 'Создать домен';
$lng['admin']['domain_edit'] = 'Редактировать домен';
$lng['admin']['subdomainforemail'] = 'Субдомены как почтовые домены';
$lng['admin']['admin'] = 'Администратор';
$lng['admin']['admins'] = 'Администраторы';
$lng['admin']['admin_add'] = 'Создать администратора';
$lng['admin']['admin_edit'] = 'Редактировать администратора';
$lng['admin']['customers_see_all'] = 'Может видеть всех клиентов?';
$lng['admin']['domains_see_all'] = 'Может видеть все домены?';
$lng['admin']['change_serversettings'] = 'Может изменить настройки сервера?';
$lng['admin']['server'] = 'Система';
$lng['admin']['serversettings'] = 'Настройки';
$lng['admin']['rebuildconf'] = 'Перестроить конфигурационные файлы';
$lng['admin']['stdsubdomain'] = 'Стандартный субдомен';
$lng['admin']['stdsubdomain_add'] = 'Создать стандартный субдомен';
$lng['admin']['phpenabled'] = 'PHP включен';
$lng['admin']['deactivated'] = 'деактивированный';
$lng['admin']['deactivated_user'] = 'Деактивировать пользователя';
$lng['admin']['sendpassword'] = 'Отправить пароль';
$lng['admin']['ownvhostsettings'] = 'Свои vHost-настройки';
...
$lng['admin']['templates']['template_edit'] = 'Редактировать шаблон';
$lng['admin']['templates']['action'] = 'Действие';
$lng['admin']['templates']['email'] = 'Email & file шаблоны';
$lng['admin']['templates']['subject'] = 'Тема';
$lng['admin']['templates']['mailbody'] = 'Тело письма';
$lng['admin']['templates']['createcustomer'] = 'Приветственное письмо для новых клиентов';
$lng['admin']['templates']['pop_success'] = 'Приветственное письмо для новых учетных записей электронной почты';
$lng['admin']['templates']['template_replace_vars'] = 'Переменные, подлежащие замене в шаблоне:';
$lng['admin']['templates']['SALUTATION'] = 'Заменено правильным приветствием (имя или компания)';
$lng['admin']['templates']['FIRSTNAME'] = 'Заменено именем клиента.';
$lng['admin']['templates']['NAME'] = 'Replaced with the customers name.';
$lng['admin']['templates']['COMPANY'] = 'Заменено фамилией клиента.';
$lng['admin']['templates']['USERNAME'] = 'Заменено имя пользователя учетной записи клиента.';
$lng['admin']['templates']['PASSWORD'] = 'Заменен пароль учетной записи клиентов.';
$lng['admin']['templates']['EMAIL'] = 'Заменяется адресом учетной записи POP3 / IMAP.';
$lng['admin']['webserver'] = 'Веб сервер';
$lng['admin']['bindzonewarning'] = $lng['panel']['emptyfordefault'] . '<br /><strong class="red">ВНИМАНИЕ:</strong> Если вы используете файл зоны, вам также необходимо будет управлять всеми необходимыми записями для всех подзон.';
